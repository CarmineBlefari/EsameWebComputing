...
<body>
	...
	<main>
		...
		<h2 class="title-annunci">Qui sotto puoi modificare o eliminare annunci!</h2>
		<p>Benvenuto amministratore : ${username}</p> 
		<hr>
		<br>
		<h2 class="title-annunci">Puoi Bannare l'utente inserito : </h2>
		<div>
			<input id="utenteDaBannare" class="ban" type="text" placeholder="username">
			<input type="button" class="button-annuncio" value="Banna Utente" id="btnBannaUtente">
		</div>
		<br>
		<div>
			<input id="utenteDaPromuovere" class="ban" type="text" placeholder="username">
			<input type="button" class="button-annuncio" value="Rendi Amministratore" id="btnPromuovi">
		</div>
		<hr>
		<br>
		
		<form method="post" action="modificaAnnuncio">
			<table id="annunci" class = "table-annunci-elenco-amministratore" border = "1">
		        <tbody>
		        		<tr>
		        			<th>Azioni</th>
    ...
    <script src="../js/main.js"></script>
    <script src="../js/bannaUtente.js"></script>
    <script src="../js/promuoviUtente.js"></script>
