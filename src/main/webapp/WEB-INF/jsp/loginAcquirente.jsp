...
<body>
    ...
    <nav class="nav">
        <div class="nav-menu flex-row">
            ...
            <div>
                <ul class="nav-items">
                    <li class="nav-links">
                        <a href="gestioneAnnunci/elencoAnnunciAcquirente">ANNUNCI</a>
                    </li>
                </ul>
            </div>
	...
	<main>
		...
		<h2 class="title-annunci">Qui sotto puoi creare,modificare o eliminare aggiungi!</h2>
		<p>Benvenuto acquirente : ${username}</p> 
		<hr>
		<h2 class="title-annunci">Contata un Venditore!</h2>
		<p>Aggiungi username acquirente , il tuo e contatta!</p>
		<div class="title-annunci">
			<form method="post" action="aggiungiMessaggio">
				<input type="text" placeholder="venditore" name="venditore">
				<input type="text" placeholder="acquirente" name="acquirente">
				<input type="text" placeholder="..." name="messaggio">
				<input type="submit" class="button-modifica" value="contatta venditore">
			</form>
		</div>
    </main>
